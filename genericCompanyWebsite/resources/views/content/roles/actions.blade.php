<a class="btn btn-xs btn-success" href="{{route('roles.show', ['id'=>$d])}}">View</a>
<a class="btn btn-xs btn-primary" href="{{route('roles.edit', ['id'=>$d])}}">Edit</a>
<button id="btn-delete-{{$d}}" class="btn btn-xs btn-danger">Delete</button>
<form action="{{route('roles.destroy', $d)}}" method="post" id="delete-{{$d}}">
