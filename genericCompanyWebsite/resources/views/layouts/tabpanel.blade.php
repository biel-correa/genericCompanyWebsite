<div role="tabpanel" class="sidepanel">
    ...
    <div class="tab-content">
        ...
        <div role="tabpanel" class="tab-pane" id="chat">
            ...
            <ul class="group">
                <li class="member"><a href="#"><img src="{{url('img/profileimg.png')}}" alt="img"><b>Allice Mingham</b>Los
                        Angeles</a><span class="status online"></span></li>
                <li class="member"><a href="#"><img src="{{url('img/profileimg2.png')}}" alt="img"><b>James Throwing</b>Las
                        Vegas</a><span class="status busy"></span></li>
                <li class="member"><a href="#"><img src="{{url('img/profileimg3.png')}}" alt="img"><b>Fred Stonefield</b>New
                        York</a><span class="status away"></span></li>
                <li class="member"><a href="#"><img src="{{url('img/profileimg4.png')}}" alt="img"><b>Chris M.
                            Johnson</b>California</a><span class="status online"></span></li>
            </ul>

            <div class="gn-title">OFFLINE MEMBERS (8)</div>
            <ul class="group">
                <li class="member"><a href="#"><img src="{{url('img/profileimg5.png')}}" alt="img"><b>Allice Mingham</b>Los
                        Angeles</a><span class="status offline"></span></li>
                <li class="member"><a href="#"><img src="{{url('img/profileimg6.png')}}" alt="img"><b>James Throwing</b>Las
